...
struct ProfileScreen: View {
    ...
    var body: some View {
            VStack(spacing: 0){
                ...
                //Rectangle().frame(width:0,height: 30)
                VStack{
                    NavigationLink{LoginAndRegisterScreen(selectedScreen: "Register").environmentObject(vm)}label: {
                        Text("Register")
                    ...
                    NavigationLink{
                        LoginAndRegisterScreen(selectedScreen: "Login").environmentObject(vm)
                    }label: {
                        Text("Log In")
                            .font(.custom("sf-ui-display-semibold",size: 18))
                            .foregroundColor(Color(red: 185 / 255, green: 128 / 255, blue: 104 / 255))
